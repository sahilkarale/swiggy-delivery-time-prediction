...
dagshub.init(repo_owner='sahilkarale', repo_name='swiggy-delivery-time-prediction', mlflow=True)

# set the mlflow tracking server
mlflow.set_tracking_uri("https://dagshub.com/sahilkarale/swiggy-delivery-time-prediction.mlflow")
